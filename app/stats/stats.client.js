...
import { Trophy, Flame, Award, DollarSign, TrendingUp, Zap, ArrowLeft, Target, Star, Crown, RefreshCw } from 'lucide-react';
...
export default function StatsView({ experienceId, userId, companyId }) {
