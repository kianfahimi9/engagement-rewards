...
**URL:** `https://engage-track.preview.emergentagent.com/api/test-whop`
...
```bash
curl "https://engage-track.preview.emergentagent.com/api/test-whop?test=chat-messages&experienceId=exp_XXX"
```
...
```bash
curl "https://engage-track.preview.emergentagent.com/api/test-whop?test=forum-posts&experienceId=exp_XXX"
```
...
```bash
curl -X POST https://engage-track.preview.emergentagent.com/api/test-whop \
