...
**URL:** `https://rankwards.preview.emergentagent.com/api/test-whop`
...
```bash
curl "https://rankwards.preview.emergentagent.com/api/test-whop?test=chat-messages&experienceId=exp_XXX"
```
...
```bash
curl "https://rankwards.preview.emergentagent.com/api/test-whop?test=forum-posts&experienceId=exp_XXX"
```
...
```bash
curl -X POST https://rankwards.preview.emergentagent.com/api/test-whop \
