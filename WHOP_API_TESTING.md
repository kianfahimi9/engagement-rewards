...
**URL:** `https://engage-rank.preview.emergentagent.com/api/test-whop`
...
```bash
curl "https://engage-rank.preview.emergentagent.com/api/test-whop?test=chat-messages&experienceId=exp_XXX"
```
...
```bash
curl "https://engage-rank.preview.emergentagent.com/api/test-whop?test=forum-posts&experienceId=exp_XXX"
```
...
```bash
curl -X POST https://engage-rank.preview.emergentagent.com/api/test-whop \
