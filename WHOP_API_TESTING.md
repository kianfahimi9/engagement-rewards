...
**URL:** `https://whop-gamify.preview.emergentagent.com/api/test-whop`
...
```bash
curl "https://whop-gamify.preview.emergentagent.com/api/test-whop?test=chat-messages&experienceId=exp_XXX"
```
...
```bash
curl "https://whop-gamify.preview.emergentagent.com/api/test-whop?test=forum-posts&experienceId=exp_XXX"
```
...
```bash
curl -X POST https://whop-gamify.preview.emergentagent.com/api/test-whop \
