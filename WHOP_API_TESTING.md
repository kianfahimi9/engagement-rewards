...
**URL:** `https://community-rank-1.preview.emergentagent.com/api/test-whop`
...
```bash
curl "https://community-rank-1.preview.emergentagent.com/api/test-whop?test=chat-messages&experienceId=exp_XXX"
```
...
```bash
curl "https://community-rank-1.preview.emergentagent.com/api/test-whop?test=forum-posts&experienceId=exp_XXX"
```
...
```bash
curl -X POST https://community-rank-1.preview.emergentagent.com/api/test-whop \
