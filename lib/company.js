 ...
 * NEW SDK: Use experiences.retrieve() which includes company info
...
export const getCompanyFromExperience = cache(
  async (experienceId) => {
    try {
      ...
      // Try database cache first for faster subsequent loads
      ...
      // Use official Whop SDK method to get experience with company info
      console.log('🔍 Fetching experience from Whop API...');
